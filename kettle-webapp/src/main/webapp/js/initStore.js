Ext.onReady(function() {
	...
	new Ext.data.JsonStore({
		storeId:'fontnameStore',
		fields: ['value','text'],
		proxy: new Ext.data.HttpProxy({
		url: GetUrl('system/fontname.do'),
			method: 'POST'
		})
	}).load();
	
	new Ext.data.JsonStore({
		storeId:'fontunderlineStore',
		fields: ['value','text'],
		proxy: new Ext.data.HttpProxy({
		url: GetUrl('system/fontunderline.do'),
			method: 'POST'
		})
	}).load();
	
	new Ext.data.JsonStore({
		storeId:'fontorientionStore',
		fields: ['value','text'],
		proxy: new Ext.data.HttpProxy({
		url: GetUrl('system/fontoriention.do'),
			method: 'POST'
		})
	}).load();
	...
	new Ext.data.JsonStore({
		...
		fields: ['value','text'],
		proxy: new Ext.data.HttpProxy({
		url: GetUrl('system/fontcolor.do'),
			method: 'POST'
		})
	}).load();
	
	new Ext.data.JsonStore({
		storeId:'fontalignmentStore',
		fields: ['value','text'],
		proxy: new Ext.data.HttpProxy({
		url: GetUrl('system/fontalignment.do'),
			method: 'POST'
		})
	}).load();
	...
	new Ext.data.JsonStore({
		storeId:'excelrowwritemethodStore',
		fields: ['value','text'],
		proxy: new Ext.data.HttpProxy({
		url: GetUrl('system/excelrowwritemethod.do'),
			method: 'POST'
		})
	}).load();
	
	new Ext.data.JsonStore({
		storeId:'excelwritemethodStore',
		fields: ['value','text'],
		proxy: new Ext.data.HttpProxy({
		url: GetUrl('system/excelwritemethod.do'),
			method: 'POST'
		})
	}).load();
	
	new Ext.data.JsonStore({
		storeId:'excelTypeStore',
		fields: ['value','text'],
		proxy: new Ext.data.HttpProxy({
		url: GetUrl('system/excelType.do'),
			method: 'POST'
		})
	}).load();
});